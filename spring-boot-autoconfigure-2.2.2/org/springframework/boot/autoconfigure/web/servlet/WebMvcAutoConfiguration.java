...
public class WebMvcAutoConfiguration {
	...
	public static class WebMvcAutoConfigurationAdapter implements WebMvcConfigurer {
		...
		@Bean// 向容器中添加ContentNegotiatingViewResolver组件
		...
		public void addResourceHandlers(ResourceHandlerRegistry registry) {
			...
			// 静态资源加载，www.webjars.org网站找到需要加载的资源加入到pom.xml的dependency中
			...
			if (!registry.hasMappingForPattern(staticPathPattern)) {
				customizeResourceHandlerRegistration(registry.addResourceHandler(staticPathPattern)
						.addResourceLocations(getResourceLocations(this.resourceProperties.getStaticLocations()))// 图片、css等自定义静态资源加载路径
						.setCachePeriod(getSeconds(cachePeriod)).setCacheControl(cacheControl));
			}
		}
